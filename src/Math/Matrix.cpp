...
const float* vsMat2::ToTypePtr( void ) const {
	return ( &_mat[0] );
}
...
const float* vsMat3::ToTypePtr( void ) const {
	return ( &_mat[0] );
}
...
const float* vsMat4::ToTypePtr( void ) const {
	return ( &_mat[0] );
}
...
================================
*/
void vsMat4::Ortho( float left, float right, float bottom, float top, float znear, float zfar ) {
...
===============================
*/
void vsMat4::Perspective( float fieldOfView, float aspect, float nearPlane ) 
{	
	float f  = 1.0f / tanf( fieldOfView * DEG_TO_RAD * 0.5f );
