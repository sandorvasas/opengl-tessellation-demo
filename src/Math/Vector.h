...
typedef vsVec2<long int>		vsVec2li;
typedef vsVec3<long int>		vsVec3li;
typedef vsVec4<long int>		vsVec4li;
typedef vsVec2<long long int>	vsVec2lli;
typedef vsVec3<long long int>	vsVec3lli;
typedef vsVec4<long long int>	vsVec4lli;
